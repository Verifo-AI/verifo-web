              ...
              <div className="pt-4 border-t border-border mt-1">
                <div className="flex items-center justify-center gap-3">
                  <a
                    ...
                    rel="noreferrer"
                    onClick={() => setMobileMenuOpen(false)}
                    className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border border-border bg-card hover:border-primary/40 hover:bg-primary/5 transition-all duration-200"
                    aria-label="GitHub"
                  >
                  ...
                  <a
                    ...
                    aria-label="PumpFun"
                  >
                    <img src="/pumpfun-logo.webp" alt="PumpFun" className="w-4 h-4 object-contain rounded-sm" />
                    <span className="text-xs font-semibold text-muted-foreground">Pump</span>
                  </a>
                </div>
              </div>
            </div>
